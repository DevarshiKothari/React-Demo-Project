...
export default function AboutUs() {
  ...
  return (
        <>
            <div className='container my-1 w-50 p-2' style={theme}>
            <h1>About Us</h1>
                ...
                <div className='my-2'>
                    <button type="button" className="btn btn-primary btn-block" onClick={handleTheme}>Change Theme to {themeColor}</button>
                </div>
            ...
            {/* <button type="button" className="btn btn-primary">Change Theme</button> */}
